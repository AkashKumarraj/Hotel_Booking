...
const Hero = () => {
  ...
  const onSearch = async (e) => {
    ...
    //call api to save the recent seacrhed city
    await axios.post('/api/user/store-recent-search', {
      recentSearchedCity:
        destination
    }, { headers: { Authorization: `Bearer ${await getToken()}` } })

    //add destination to max 3 recent searched cities
  ...
  return (
    ...
    md:px-16 lg:px-24 xl:px-32 text-white' style={{ backgroundImage: `url(${assets.heroImage})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center', height: '100vh' }}>
