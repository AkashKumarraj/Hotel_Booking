...
const Dashboard = () => {
    ...
    return (
        ...
        room listings, tracvk bookings and analyze revenue-all in one place. Stay
        updated with real-time insights to ensure smooth operations' />

            <div className='flex gap-4 my-8'>
                {/* Total Bookings */}
                <div className='bg-primary/3 border boprder-primary/10 rounded flex p-4
            pr-8'>
                    ...
                    <tbody className='text-sm'>
                        {dashboardData.bookings.map((item, index) => (
                            ...
                            text-center'>
                                ...
                                <td className='py-3 px-4 border-gray-300 flex'>
