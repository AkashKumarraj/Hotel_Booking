        ...
        <form>
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                ...
                <div>
                    ...
                    <input type="number" placeholder='0' className='border border-gray-300 mty-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e =>
                    ...
                    <div key={index}>
                        <input type="checkbox" id={`amenities${index + 1}`} checked=
                            {inputs.amenities[amenity]} onChange={() => setInputs({
                                ...inputs,
                                amenities: {
                                    ...inputs.amenities, [amenity]: !inputs.amenities
                                    [amenity]
                                }
                            })} />
